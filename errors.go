...
var (
	...
	ErrInvalidSPIFFEID    = errors.New("m2mauth: invalid SPIFFE ID")
	ErrWrongTrustDomain   = errors.New("m2mauth: SPIFFE ID trust domain mismatch")
	ErrSPIFFEIDNotAllowed = errors.New("m2mauth: SPIFFE ID not in allowlist")
)
